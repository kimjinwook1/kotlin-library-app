...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        val request = BookLoanRequest("김진욱", "이상한 나라의 앨리스")
    ...
    fun loanBookFailTest() {
        // given
        val saveBook = bookRepository.save(Book("이상한 나라의 앨리스"))
        val savedUser = userRepository.save(User("김진욱", null))
        userLoanHistoryRepository.save(UserLoanHistory(savedUser, saveBook.name, false))
        val request = BookLoanRequest("김진욱", "이상한 나라의 앨리스")
